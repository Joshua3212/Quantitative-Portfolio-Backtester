...
- [pdm (Python Development Master)](https://pdm.fming.dev/latest/)  (Install pdm with: `pip install pdm`)

## Running the application
- clone the repository with `git clone https://github.com/Joshua3212/quantitative-portfolio-backtester.git`
- cd /quantitative-portfolio-backtester
- pdm install
- pdm run start
